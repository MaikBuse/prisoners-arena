...
- Entry counter integration tests (v1.2 test suite)
...
- Documented entry rent destinations in architecture spec (player for claim/refund, operator for expired cleanup)
