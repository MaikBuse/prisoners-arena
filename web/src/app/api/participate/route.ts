...
export async function GET(request: NextRequest) {
  ...
  return apiSuccess({
    ...
    verification: {
      ...
      command: `solana-verify verify-from-repo https://github.com/MaikBuse/prisoners-arena-program --program-id ${programId} --library-name prisoners_arena --base-image solanafoundation/solana-verifiable-build:3.0.1 -u ${getConfig().rpcUrl}`,
