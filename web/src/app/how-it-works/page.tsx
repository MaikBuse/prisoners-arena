        ...
        <div className="flex-1 min-w-0 space-y-12">
          ...
          <Section id="security" title="Security & Verification">
            ...
            <DetailBlock summary="How to verify the program binary">
              <div className="text-sm text-[var(--muted)] space-y-2">
                <p>1. Clone the source: <code className="bg-[var(--surface)] px-1 rounded text-xs font-mono">git clone https://github.com/makoto-kusanagi/prisoners-arena-program</code></p>
                <p>2. Build with Anchor: <code className="bg-[var(--surface)] px-1 rounded text-xs font-mono">anchor build</code></p>
                <p>3. Compare the resulting <code className="bg-[var(--surface)] px-1 rounded text-xs font-mono">.so</code> hash with the deployed binary hash on Solana Explorer</p>
                <p>4. Use <code className="bg-[var(--surface)] px-1 rounded text-xs font-mono">anchor verify</code> for automated verification against the deployed program</p>
              </div>
            </DetailBlock>
